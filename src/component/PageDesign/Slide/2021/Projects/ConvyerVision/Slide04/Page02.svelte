...
<DefaultPage color={color} fontSize={subhead} bind:curPage={curPage}>
    ...
    <div class="borderBox" 
        style="font-size:{context}rem;border: solid {$Color["btnBdrColor"][$season]} 1px; background-color:{$Color["btnBackColor"][$season]}; color:{$Color["btnBdrColor"][$season]};top: {$Device['isMobile'] ? "50%" : "75%"}; left: {$Device['isMobile'] ? "32.5%" : "40%"};">
        Convyer
    </div>
    <div class="borderBox" 
        style="font-size:{context}rem;border: solid {$Color["btnBdrColor"][$season]} 1px; background-color:{$Color["btnBackColor"][$season]}; color:{$Color["btnBdrColor"][$season]};top: {$Device['isMobile'] ? "50%" : "75%"}; left: {$Device['isMobile'] ? "67.5%" : "60%"};">
        Vision<br/>
        Pro
    </div>
</DefaultPage>
