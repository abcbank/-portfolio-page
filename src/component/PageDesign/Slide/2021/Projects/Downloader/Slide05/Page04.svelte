<script>
	...
	let failed = false;
	let loading = false;
    let src = "http://drive.google.com/uc?export=view&id=1PFoS4XFi35Pb0miNkQ8-JTkBTvqDvnHd";
...
<DefaultPage color={color} fontSize={subhead}>
    ...
    {#if loaded}
    <img in:fade={{ duration:300,}} {src} width="auto" height="80%" alt="downloader_zig_1" />
    {:else if failed}
