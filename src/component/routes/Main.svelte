<script>
    ...
    import Slide01 from '../PageDesign/Slide/Main/Slide01.svelte'
    import Slide02 from '../PageDesign/Slide/Main/Slide02.svelte'
    import Slide03 from '../PageDesign/Slide/Main/Slide03.svelte'
    import Slide04 from '../PageDesign/Slide/Main/Slide04.svelte'
    import Slide05 from '../PageDesign/Slide/Main/Slide05.svelte'
    import Slide06 from '../PageDesign/Slide/Main/Slide06.svelte'
    import Slide07 from '../PageDesign/Slide/Main/Slide07.svelte'
    import Slide08 from '../PageDesign/Slide/Main/Slide08.svelte'
...
<div
    ...
    <DefaultPage 
        slides={[
            { childComponent:Slide01, bg: $Color["backColor"][$season], color: $Color["foreColor"][$season], buttonBackColor: $Color["btnBackColor"][$season], buttonBorderColor: $Color["btnBdrColor"][$season], buttonSelectedColor: $Color["btnSelectedColor"][$season]},
            ...
            { childComponent:Slide08, bg: $Color["backColor"][$season], color: $Color["foreColor"][$season], buttonBackColor: $Color["btnBackColor"][$season], buttonBorderColor: $Color["btnBdrColor"][$season], buttonSelectedColor: $Color["btnSelectedColor"][$season]}
        ]}>
    </DefaultPage>
</div>
